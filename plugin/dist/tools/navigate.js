...
export const openUrlTool = {
    name: "open_url",
    description: "Opens a URL in a NEW Chrome tab (never touches the tab the user is on) and brings it to focus, " +
...
export async function runOpenUrl(args) {
    ...
    try {
        ...
        return {
            content: [
                { type: "text", text: `Opened in a new tab.\nURL: ${page.url()}\nTitle: ${title}` },
            ],
        };
    }
    finally {
